...
let m=56;let r=()=>{let i=Math.random()*2-1;return(i<0)?i-1:i+1};
...
//for(let p=164;p>=0;p-=4){for(let y=0;y<164;y++){for(let x=0;x<560;x++)
...
while (sys.nanoTime() - time < 2147483648) sys.spin();
// clear screen
